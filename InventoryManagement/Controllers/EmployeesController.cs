    ...
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserName,FirstName,LastName,Email,IsAdmin,Password")] Employee employee, string[] selectedFacilities)
        {
            if (selectedFacilities != null)
            {
                ...
                foreach (var facilities in selectedFacilities)
                {
                    var facilitiesToAdd = db.Facilities.Find(int.Parse(facilities));
                    employee.Facilities.Add(facilitiesToAdd);
                }
            }
            if (ModelState.IsValid)
            {
                ...
                if (!alreadyCreated.Contains(employee.Email))
                {
                ...
                {
                    TempData["Disable Registration"] = "disable";
                    return View("Create");
                }
            }
            return View(employee);
